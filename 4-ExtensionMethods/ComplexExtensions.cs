...
namespace ExtensionMethods
{
    ...
    public static class ComplexExtensions
    {
        ...
        {
            double newRe = (c1.Real*c2.Real - c1.Imaginary*c2.Imaginary)/(Math.Pow(c2.Real, 2) + (Math.Pow(c2.Imaginary, 2)));
            double newIm = (c1.Imaginary*c2.Real - c1.Real*c2.Imaginary)/(Math.Pow(c2.Real, 2) + (Math.Pow(c2.Imaginary, 2)));
        ...
        {
            IComplex newComp = Divide(c1, c1);
            return new Complex(newComp.Real, newComp.Imaginary);
        }
    }
}
